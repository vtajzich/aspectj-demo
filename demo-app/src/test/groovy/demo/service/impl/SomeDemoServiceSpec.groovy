 ...
 * Created by vtajzich
 */
class SomeDemoServiceSpec extends Specification {
    ...
    SomeDemoService someDemoService
    ...
    void setup() {
        ...
        someDemoService = new SomeDemoService(externalSystemConnector, securityService, transactionManager, performanceMonitor)
    }
